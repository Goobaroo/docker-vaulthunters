# [Vault Hunters - 1.13.8](https://www.curseforge.com/minecraft/modpacks/vault-hunters-official-modpack) on Curseforge
...
The docker on first run will download the same version as tagged of `Vault Hunters - 1.13.8` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "Vault Hunters - 1.13.8 Server Powered by Docker"
* LEVEL world
